    ...
    <div class="site-wrap">
        ...
        <div class="unit-5 overlay" style="background-image: url('images/hero_1.jpg');">
            <div class="container text-center">
                <h2 class="mb-0">Login To Admin Panel</h2>
                <p class="mb-0 unit-6"><a href="index.php" style="color: purple;">Home</a> <span class="sep">/</span> <span>Login</span></p>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        ...
                        <form action="login.php" class="p-6 bg-white" method="post" style="margin-left: 400px;">

                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="font-weight-bold" for="title">User Name</label>
                            ...
                            <div class="row form-group mb-5">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <input type="password" id="company" class="form-control" name="pass" placeholder="Password" required>
                                </div>
                            </div>

                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input type="submit" name="login" value="Login" class="btn btn-primary  py-2 px-5 " style="background-color: rgb(130, 32, 117);border:purple">
                                </div>
                            </div>
