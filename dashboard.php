...
<ul class="nav nav-tabs" style="margin-left: 20px">
  <li class="active" style="padding-right:20px; background:black"><a href="dashboard.php">Land's</a></li><br>
...
<h2><form><a type="submit" href="landcreate.php" class="btn btn-primary">Add Property</a></h2><br>
...
<table>
  ...
  <tr>
    ...
    <td><a href="landedit.php?id=<?php echo $row['Id']?>">Edit</a></td>
    <td><a href="landdelete.php?id=<?php echo $row['Id']?>">Delete</a></td>
  </tr>
  <?php
}
?>
