    ...
    <div class="site-wrap">
        ...
        <div class="unit-5 overlay" style="background-image: url('images/dashboard_img.png');">
            <div class="container text-center">
                ...
                <p class="mb-0 unit-6"><a href="index.php" style="color: white;">Home</a> <span class="sep">/</span> <span>User Edit</span></p>
            </div>
        </div>
...
<?php
           ...
           $id = $_GET['id'];
            ...
            ?>
                        <form action="userupdate.php" class="p-5 bg-white" method="post" enctype="multipart/form-data">

                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="font-weight-bold" for="title">
                                        <h1><b>Edit User Detail</b></h1>
                                    </label>
                                </div>
                            </div>
                            <hr><br>
                            ...
                            <div class="row form-group mb-5">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <input type="text" id="company" class="form-control" name="pass" placeholder="Name" value="<?php echo $row['Password']; ?>" required>
                                 </div>
                            </div>

                            <div class="row form-group">
                                <div class="col-md-12">
                                    <input type="submit" name="update" value="Post a Property" class="btn btn-primary  py-2 px-5" style="background-color: rgb(130, 32, 117);border:purple">
                                </div>
                            </div>
