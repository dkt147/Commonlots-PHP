    ...
    <div class="site-wrap">
        ...
        <div class="unit-5 overlay" style="background-image: url('images/dashboard_img.png');">
            <div class="container text-center">
                ...
                <p class="mb-0 unit-6"><a href="index.php" style="color: white;">Home</a> <span class="sep">/</span> <span>Subscriber</span></p>
            </div>
        </div>
...
<ul class="nav nav-tabs" style="margin-left: 20px">
  ...
  <li><a href="userlist.php" style="padding-right:20px;">User</a></li><br>
  <li><a href="subscriberlist.php" style="padding-right:20px;background:black  ">Subscriber</a></li><br>
</ul>
<br><br>

<h2><form><a type="submit" href="subscribercreate.php" class="btn btn-primary">Add Subscriber</a></h2><br>
...
<table>
  ...
  <tr>
    ...
    <td><a href="subscriberedit.php?id=<?php echo $row['Id']?>">Edit</a></td>
    <td><a href="subscriberdelete.php?id=<?php echo $row['Id']?>">Delete</a></td>
  </tr>
  <?php
}
?>
