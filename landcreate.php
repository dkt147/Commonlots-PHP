...
<body>
 ...
 $con = mysqli_connect("markg18140.domaincommysql.com", "real_state", "2439123Mm!", "real_state");
    ...
    if (isset($_POST["add"])) {
        ...
        $sql = "INSERT INTO `land`(`Description`, `Price`, `Image`) VALUES ('$desc','$price','$target_file')";
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        ...
                        <form action="landcreate.php" class="p-5 bg-white" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <textarea class="form-control" name="desc" cols="30" rows="5" placeholder="Property Description" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row form-group mb-5">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <input type="text" id="company" class="form-control" name="price" placeholder="Price" required>
                                </div>
                            </div>
                            <div class="row form-group mb-5">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <label class="font-weight-bold" for="company">Property Image</label>
                                    <input type="file" id="company" class="form-control" name="file" placeholder="Price" required>
                                </div>
                            </div>
